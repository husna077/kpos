...
function PrintBarcode({onChange = () => {}}) {
    ...
    return(
        <div className="add-supply-main">
            ...
            <div className="add-supply-heading-div">
                    <p id="add-supply-text">Add Barcode</p>
                </div>
                 <form>
            <div className="form-info-div">
                    ...
                    <div className="add-supply">
                        ...
                        /></div>
                        <div className="add-supply-info-div" >
                        <lable className="info-name-lable">Barcode Number</lable>
                        <input 
                        type="email"
                        name="email"
                        id="add-supply-name"/>
                    ...
                    <div className="add-supply">
                        ...
                        <div className="add-supply-info-div">
                        <lable className="info-name-lable">Upload Barcode </lable>
                        <input 
                        type="text"
                        name="name"
                        id="add-supply-name"/>
                    ...
                    <button type="Submit" id="add-supply-btn">Add Barcode</button>
