...
import './SupplySummary.css';
import { useState, useEffect } from "react";

function SupplySummary({ onChange = () => { } }) {
    ...
    return (
        <div className="branchwise-main">
            ...
            <div className="branchwise-content">
                <p className="stock-summary">Product Supply Summary</p>
            ...
            <div className="list-stock">
                    <table>
                        <thead className="table-head">
                            <tr><th>Sr.No</th><th>Product Name</th><th>Supply</th><th>Branch</th></tr>
                        </thead>
                        <tbody>
                            {data.map((item) => (
